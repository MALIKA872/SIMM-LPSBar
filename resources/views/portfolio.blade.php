    ...
    <div class="min-h-screen bg-base-100">
        ...
        <div class="navbar bg-base-100 shadow-lg">
            <div class="container mx-auto">
                ...
                <a href="/dashboard" class="btn mr-2">Go to Dashboard</a>
        ...
        <section class="hero min-h-screen bg-gradient-to-r from-blue-100 via-green-100 to-yellow-100" x-data="{ activeTab: 'about' }">
                ...
                <div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
                    <div class="avatar mb-8 mx-auto">
                        <div class="w-32 h-32 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                            <img src="{{ asset('storage/' . $data->image) }}" alt="Alif Panje" class="object-cover w-full h-full rounded-full"/>
                        </div>
                    </div>
                    <h1 class="text-4xl font-extrabold text-gray-900 mb-4">{{ $data->nama }}</h1>
                    <p class="text-xl text-gray-600 mb-8">Fullstack dev</p>
                    ...
                    <div x-show="activeTab === 'about'" class="space-y-4">
                        <p class="text-lg text-gray-700">{{ $data->nim }}</p>
                        <p class="text-lg text-gray-700">{{ $data->phone }}</p>
                        <p class="text-lg text-gray-700">{{ $data->email }}</p>
                        <p class="text-lg text-gray-600">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab architecto non eos, quas necessitatibus distinctio nam. Fugit nemo quibusdam excepturi impedit numquam molestias aut quos? Ipsam debitis nesciunt qui sint?</p>
