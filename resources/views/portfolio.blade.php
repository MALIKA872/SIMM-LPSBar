    ...
    <div class="min-h-screen bg-base-100">
        ...
        <div class="navbar bg-base-100 shadow-lg">
            <div class="container mx-auto">
                <div class="flex-1">
                    <a class="btn btn-ghost text-xl">Dual Portfolio</a>
                </div>
                <div class="flex-none">
        ...
        <!-- First Portfolio -->
        <section class="hero min-h-screen bg-base-200" x-data="{ activeTab: 'about' }" ="100px">
            <div class="hero-content text-center">
                @foreach ($portfolioData as $data)
                <div class="max-w-4xl ">
                    <div class="avatar mb-8">
                        <div class="w-32 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                            <img src="{{ asset('storage/' . $data->image) }}" alt="Alif Panje" />
                        </div>
                    </div>
                    <h1 class="text-5xl font-bold mb-4">{{ $data->nama }}</h1>
                    <p class="text-xl mb-8">{{ $data->role }}</p>
